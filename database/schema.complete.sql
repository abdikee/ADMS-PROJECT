...
CREATE TABLE IF NOT EXISTS departments (
  ...
  description    TEXT,
  head_teacher_id BIGINT NULL,  -- FK added after teachers table
  created_at     TIMESTAMPTZ  DEFAULT CURRENT_TIMESTAMP
);
...
-- Teacher → Subject → Class assignment (one teacher teaches one subject per class)
...
-- ============================================================
-- DEFERRED FOREIGN KEY: departments.head_teacher_id
-- (teachers table must exist first)
-- ============================================================
...
INSERT INTO subjects (name, code, max_marks, passing_marks, department_id, credit_hours) VALUES
  ...
  ('History',     'HIST101', 100, 40, (SELECT id FROM departments WHERE code = 'SS'),   3)
ON CONFLICT (code) DO NOTHING;
